...
func TestNewInvalidConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "zero hop size", cfg: Config{SampleRate: base.SampleRate, WindowSize: base.WindowSize, HopSize: 0, FFTSize: base.FFTSize, NumMels: base.NumMels, LowFreq: base.LowFreq, HighFreq: base.HighFreq, PreEmphasis: base.PreEmphasis}},
		{name: "zero window size", cfg: Config{SampleRate: base.SampleRate, WindowSize: 0, HopSize: base.HopSize, FFTSize: base.FFTSize, NumMels: base.NumMels, LowFreq: base.LowFreq, HighFreq: base.HighFreq, PreEmphasis: base.PreEmphasis}},
		{name: "zero fft size", cfg: Config{SampleRate: base.SampleRate, WindowSize: base.WindowSize, HopSize: base.HopSize, FFTSize: 0, NumMels: base.NumMels, LowFreq: base.LowFreq, HighFreq: base.HighFreq, PreEmphasis: base.PreEmphasis}},
		{name: "fft smaller than window", cfg: Config{SampleRate: base.SampleRate, WindowSize: 400, HopSize: base.HopSize, FFTSize: 256, NumMels: base.NumMels, LowFreq: base.LowFreq, HighFreq: base.HighFreq, PreEmphasis: base.PreEmphasis}},
	}
...
func TestMustNewPanicsOnInvalidConfig(t *testing.T) {
	defer func() {
		if recover() == nil {
			t.Fatalf("MustNew should panic for invalid config")
		}
	}()

	_ = MustNew(Config{SampleRate: 16000, WindowSize: 400, HopSize: 0, FFTSize: 512, NumMels: 80, LowFreq: 20, HighFreq: 7600, PreEmphasis: 0.97})
}

func TestValidateConfigValidDefault(t *testing.T) {
...
func TestNewReturnsExtractor(t *testing.T) {
	...
	if ext == nil {
		t.Fatal("New(DefaultConfig()) returned nil extractor")
	}
}
