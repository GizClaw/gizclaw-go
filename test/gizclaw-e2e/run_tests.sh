...
go_test_timeout="45m"
chat_pkg="./test/gizclaw-e2e/client/chat"
chat_live_tests=(
...
run_pkg "./test/gizclaw-e2e/client/admin"
run_chat_pkg
run_pkg "./test/gizclaw-e2e/client/rpc"
run_pkg "./test/gizclaw-e2e/client/social"
run_pkg "./test/gizclaw-e2e/cmd/connect"
...
run_pattern "./test/gizclaw-e2e/ui/admin/..."
run_pattern "./test/gizclaw-e2e/ui/play/..."
run_pattern "./test/gizclaw-e2e/ui/smoke/..."
