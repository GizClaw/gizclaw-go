...
So that I can switch once with `giztoy context use` and then run follow-up commands naturally.

## Covered Behaviors

- `giztoy context use <name>` changes the current context.
- `giztoy ping` without `--context` uses the current context.
