...
- `admin_service.json`, `gear_service.json`, `server_public.json`,
  `peer_public.json`, `event_types.json`, and `rpc_types.json` define API
  surfaces or shared protocol documents.
